...
Tags: woocommerce subscriptions, recurring billing, subscription products,subscription management, recurring payments
...
Subscriptions are a great way to ensure regular revenue from your WooCommerce store. This WooCommerce extension helps you create simple subscriptions on your store. You can create subscriptions out of physical, downloadable or virtual products. The subscriptions can be of different billing periods and intervals. 

Once you install the plugin, you can create subscription products just like you create any other WooCommerce products. The plugin will add a field in the product type drop-down - 'simple subscription'  which you can choose accordingly. You can further add the terms for subscriptions and the renewal cycles in the Product Data settings.
...
* Manage the terms of subscriptions on the WooCommerce admin page (WooCommerce > WebToffee Subscriptions).
...
&#128226; If you have any queries, suggestions, or need help to set up this plugin, please contact us at <a href="https://www.webtoffee.com/product/woocommerce-subscriptions/">our support forum.</a>
...
* Frequent releases with new features and compatibility updates

* Excellent Support for setting it up

Please visit <a href="https://www.webtoffee.com/product/woocommerce-subscriptions/">WebToffee WooCommerce Subscriptions</a> for more details
...
**How to get a subscription and track your order using WooCommerce Subscription plugin by WebToffee?**
...
WebToffee Subscriptions for WooCommerce bundles the following third-party resource by Prospress, Inc.
...
Important: First of all, you have to download and activate WooCommerce plugin, which is essential for WebToffee Subscriptions for WooCommerce to work.

1. Unzip the downloaded zip file.
2. Upload the plugin folder into the 'wp-content/plugins/' directory of your WordPress site.
3. Activate WebToffee Subscriptions for WooCommerce from Plugins page.

= Configuration =

Subscriptions for WooCommerce will add a new menu called "WebToffee Subscriptions" under WooCommerce menu item.
...
= 1.3.6 =
Fix for WooCommerce gateway amazon payments advanced.

= 1.3.5 =
Chinese language translation added.

= 1.3.4 =
Fixed issue with bulk update order status.
...
= 1.3.2 =
Tested OK with WP 4.9.6, WC 3.4.2 and WC Stripe 4.1.7
Translation updates

= 1.3.1 =
Tested OK with WC 3.4.2.
Barclay Card Subscription Payment support fix.
Subscription Pre-paid term end cron fix.

= 1.3.0 =
Tested OK with WC 3.4.0.

= 1.2.9 =
Feedback option on deactivation.

= 1.2.8 =
Added Portuguese (BR) translation.

= 1.2.7 =
Fixed conflict with WooCommerce QuickPay.

= 1.2.6 =
Tested OK with 3.3.4.

= 1.2.5 =
Subscription Payment Tested OK with PayPal.

= 1.2.4 =
Cart page warning fix.

= 1.2.3 =
Subscription Payment Tested OK with WC WooCommerce Stripe Payment Gateway 4.0.7.
