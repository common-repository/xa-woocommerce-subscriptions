...
class HForce_Woocommerce_Subscription_Admin {
    ...
    public function hf_action_links($links) {
       ...
       $plugin_links = array(
           ...
           '<a target="_blank" href="https://wordpress.org/support/plugin/xa-woocommerce-subscriptions">' . __('Support', 'xa-woocommerce-subscription') . '</a>',
           '<a target="_blank" href="https://wordpress.org/support/plugin/xa-woocommerce-subscriptions/reviews?rate=5#new-post">' . __('Review', 'xa-woocommerce-subscription') . '</a>',
       );
    ...
    public function hf_order_button_text($button_text) {
        ...
        if (self::whether_cart_contains_subscription()) {
            ...
            $button_text = __($button_text, 'xa-woocommerce-subscription');
        }
