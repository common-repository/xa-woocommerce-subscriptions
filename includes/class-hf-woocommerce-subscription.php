...
class HForce_Woocommerce_Subscription {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'hf_subscription_status_updated', $plugin_admin ,'run_gateway_status_updated_hook', 10, 2 );
                ...
                add_action( 'woocommerce_scheduled_subscription_end_of_prepaid_term', array($this, 'reached_end_of_prepaid_term'), 10, 1 );
    ...
    public static function do_expire_subscription($subscription_id) {
        ...
        public function reached_end_of_prepaid_term($subscription_id) {
    ...
    public static function hforce_admin_notices() {
            ...
            $notice.= __('<li>Supports Simple and <b>Variable subscriptions</b>.</li>', 'xa-woocommerce-subscription');
            ...
            $notice.= __('<li>Subscription <b>Trial period</b> and <b>Signup-Fee</b> options.</li>', 'xa-woocommerce-subscription');

            echo '<div class="updated woocommerce-message hf-nav-tab"><ul>' . $notice . '</ul><div class="hf-premium-banner"><a href="https://www.webtoffee.com/product/woocommerce-subscriptions/" target="_blank"> <img src="https://www.webtoffee.com/wp-content/uploads/2018/03/banner-774x200-2.jpg"/></a></div></div>';
            }
        }
	...
	public function remove_meta_box_save( $post_id, $post ) {
                 ...
                 if(isset($_REQUEST['action2']) && $_REQUEST['action2'] == -1 && 'shop_order' === $post->post_type){
...
// End fix for tickets/ #45


// Start fix for - woocommerce-multilingual
...
// End fix for - woocommerce-multilingual

// Start Fix for WC_Amazon_Payments_Advanced.
...
// End Fix for WC_Amazon_Payments_Advanced.